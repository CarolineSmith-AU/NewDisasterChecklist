...
public class Adapter1WithEditTextListener extends RecyclerView.Adapter<Adapter1WithEditTextListener.ViewHolder> {
    ...
    public Adapter1WithEditTextListener(Context c, List<ListItem2> listItems) {
        this.c = c;
    ...
    @NonNull
    @Override
    public Adapter1WithEditTextListener.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_view_detail_basics, parent, false);
        return new Adapter1WithEditTextListener.ViewHolder(v/*, new CustomEditTextListener()*/);
    }

    @Override
    //Most integral part - binds View to data to RecyclerView
    public void onBindViewHolder(@NonNull final Adapter1WithEditTextListener.ViewHolder holder, int position) {
